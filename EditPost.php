...
if(isset($_POST["submit"])){
	...
	elseif (strlen($Title)<5) {
		...
		redirect_to("posts.php");
          ...
          if(!empty($Image)){
		   $sql = "UPDATE posts 
		           SET title='$Title',category='$category',image= '$Image',post='$postText'
		           where id='$searchingParameter' ";
		       }
		       else{
		       	 $sql = "UPDATE posts 
		           SET title='$Title',category='$category',post='$postText'
		           where id='$searchingParameter' ";
		       }
		   ...
		   move_uploaded_file($_FILES["Image"]["tmp_name"], $Target);
            ...
            if($Execute){
            	$_SESSION["successMessage"] = "Post with id: ".$searchingParameter." updated successfully.";
            	redirect_to("posts.php");
            }
            else{
            	
            	$_SESSION["errorMessage"] = print_r($Execute); 
            	redirect_to("posts.php");
            }
	...
	<div class="row" >
		<div class="offset-lg-1 col-lg-10" style="min-height: 400px;" > 
         ...
         ?>
          ...
          <form class="" action="EditPost.php?id=<?php echo $searchingParameter; ?>" method="post" enctype="multipart/form-data">
          	<div class="card bg-secondary text-light mb-3">
          		...
          		<div class="card-body bg-dark">
                     ...
                     <div class="form-group">
                     	...
                     	<textarea class="form-control" id="Post" name="postDescripton" rows="8" cols="80">
